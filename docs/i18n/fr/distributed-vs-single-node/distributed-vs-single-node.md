...
![Architecture du cycle de vie des sessions](./assets/session-lifecycle.svg)

### Topologie à plusieurs compartiments

![Topologie de stockage multi-bucket](./assets/multi-bucket-topology.svg)

### Configuration du cloud K3s

![Architecture cloud distribuée K3s](./assets/k3s-cloud-setup.svg)
