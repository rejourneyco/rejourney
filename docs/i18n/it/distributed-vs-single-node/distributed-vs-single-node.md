...
![Architettura del ciclo di vita della sessione](./assets/session-lifecycle.svg)

### Topologia multi-bucket

![Topologia di archiviazione multi-bucket](./assets/multi-bucket-topology.svg)

### K3s Configurazione cloud

![K3s architettura cloud distribuita](./assets/k3s-cloud-setup.svg)
