...
![Arquitetura do ciclo de vida da sessão](./assets/session-lifecycle.svg)

### Topologia Multi-Bucket

![Topologia de armazenamento com vários buckets](./assets/multi-bucket-topology.svg)

### Configuração da nuvem K3s

![K3s arquitetura de nuvem distribuída](./assets/k3s-cloud-setup.svg)
