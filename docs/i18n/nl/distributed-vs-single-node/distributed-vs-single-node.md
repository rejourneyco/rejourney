...
![architectuur van de sessielevenscyclus](./assets/session-lifecycle.svg)

### Topologie met meerdere buckets

![Opslagtopologie met meerdere buckets](./assets/multi-bucket-topology.svg)

### K3s Cloud-installatie

![K3s gedistribueerde cloudarchitectuur](./assets/k3s-cloud-setup.svg)
