...
![Sitzungslebenszyklusarchitektur](./assets/session-lifecycle.svg)

### Multi-Bucket-Topologie

![Multi-Bucket-Speichertopologie](./assets/multi-bucket-topology.svg)

### K3s Cloud-Setup

![K3s verteilte Cloud-Architektur](./assets/k3s-cloud-setup.svg)
