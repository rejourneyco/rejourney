...
![Architektura cyklu życia sesji](./assets/session-lifecycle.svg)

### Topologia wielu segmentów

![Topologia pamięci masowej z wieloma zasobnikami](./assets/multi-bucket-topology.svg)

### K3s Konfiguracja chmury

![K3s rozproszona architektura chmury](./assets/k3s-cloud-setup.svg)
