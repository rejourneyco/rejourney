...
प्रोजेक्ट सेटिंग्स नए ऐप बिल्ड को शिपिंग किए बिना React Native रिकॉर्डिंग डिफ़ॉल्ट को नियंत्रित कर सकती हैं। समर्थित SDK संस्करण सत्र प्रारंभ पर रिमोट रिकॉर्डिंग एफपीएस सेटिंग पढ़ते हैं; डिफ़ॉल्ट 1 एफपीएस है, और प्रोजेक्ट व्यवस्थापक 1, 2, या 3 एफपीएस चुन सकते हैं। यदि रिमोट कॉन्फ़िगरेशन अनुपलब्ध है, तो SDK स्थानीय/डिफ़ॉल्ट कैप्चर व्यवहार पर वापस आ जाता है।
...
टेक्स्ट इनपुट और कैमरा दृश्य डिफ़ॉल्ट रूप से स्वचालित रूप से मास्क हो जाते हैं। प्रोजेक्ट व्यवस्थापक समर्थित SDK संस्करणों के लिए प्रोजेक्ट सेटिंग्स में डिफ़ॉल्ट टेक्स्ट इनपुट मास्किंग स्तर को बदल सकते हैं; पुराने SDK संस्करण उस दूरस्थ सेटिंग को अनदेखा करते हैं और अपने मौजूदा मास्किंग व्यवहार को बनाए रखते हैं। सुरक्षित/पासवर्ड फ़ील्ड, कैमरा दृश्य और स्पष्ट मास्क सुरक्षित रहते हैं।
...
आईपी-व्युत्पन्न जियोलोकेशन (देश, क्षेत्र, शहर) डिफ़ॉल्ट रूप से एकत्र किया जाता है। जब `collectGeoLocation`, `false` है, तो SDK मूल परत पर एक ध्वज भेजता है जो बैकएंड पर आईपी जियोलोकेशन लुकअप को दबा देता है - उस सत्र के लिए कोई स्थान डेटा संग्रहीत नहीं किया जाता है। यदि आपको स्थान डेटा की आवश्यकता नहीं है या आप ईईए उपयोगकर्ताओं के लिए डेटा संग्रह को कम करना चाहते हैं तो इसे अक्षम करें:
...
सक्षम होने पर, सभी टेलीमेट्री एकत्र की जाती है लेकिन कोई स्क्रीनशॉट नहीं लिया जाता है - सत्र आपके रीप्ले पेज में दिखाई नहीं देंगे लेकिन पूर्ण विश्लेषण/त्रुटि/नेटवर्क/क्रैश डेटा होगा। कोई पुनरावृत्ति नहीं। यह तब उपयोगी है जब उपयोगकर्ताओं ने स्क्रीन रिकॉर्डिंग से ऑप्ट आउट कर लिया है लेकिन आप अभी भी त्रुटि दृश्यता चाहते हैं।
