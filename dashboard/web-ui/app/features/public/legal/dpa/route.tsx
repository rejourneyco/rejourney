                ...
                <div>
                    ...
                    <div className="bg-muted/30 border border-input rounded-lg p-8 space-y-6">
                        <div className="text-sm leading-relaxed space-y-6">
                            ...
                            <p>Categories of personal data: IP addresses, device identifiers, pseudonymous visitor keys (keyed hashes of device or user identifiers with first-seen, last-seen, and session-count values), approximate geolocation (country, region, city), session recordings, and interaction metadata.</p>
                            ...
                            <ul className="list-disc list-inside space-y-2 ml-4">
                                ...
                                <li><strong>Pseudonymization:</strong> User identifiers are hashed upon ingest to prevent direct identification. Returning-visitor recognition relies on a visitor key derived by HMAC with a server-side secret, stored without the raw identifier, expiring on a Controller-configured sliding inactivity window (default 90 days, never shorter than session retention), and deletable per data subject through the Service's visitor erasure function.</li>
