...
const demoReplaySessionMetadataById: Record<string, DemoReplaySessionMetadata> = {
    ...
    [webDemoReplayFixture.sessionId]: {
        ...
        metadata: {
            ...
            webReferral: 'https://community.example.com/topics/rejourney-launch?utm_source=community&utm_medium=referral&utm_campaign=rejourney-launch&utm_content=classic-post',
...
const demoReferralSourceFixtures = [
    ...
    { source: 'community.example.com', channel: 'community', campaign: 'ecommerce-discussion', sessions: 7 },
