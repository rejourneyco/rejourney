...
export const MARKETING_LOCALES: Record<MarketingLocaleCode, MarketingLocale> = {
  en: {
    ...
    ogLocale: "en_US",
    dir: "ltr",
    metaTitle: "Lightweight Product Analytics for Web & Mobile | Rejourney",
    metaDescription:
      "Lightweight product analytics with session replay, funnels, heatmaps, crash and API context for web, React Native, Flutter, and iOS. Start free.",
    keywords: [
    ...
    mainAriaLabel: "Rejourney - Lightweight Product Analytics for Web and Mobile Apps",
    hero: {
      headlinePrimary: "Lightweight Product Analytics",
      headlineSecondary: "Tiny SDK. Big impact.",
...
const englishHomeCopy: MarketingHomeCopy = {
  header: {
    ...
    logoAlt: "Rejourney | Lightweight Product Analytics for Web and Mobile",
