...
const englishContentCopy: ContentLocaleCopy = {
  ...
  pricing: {
    ...
    planDescriptions: {
      ...
      scale: "For high-scale funnels that need high-intent capture control.",
    ...
    perMonth: "per month",
    perYear: "per year",
    sessionsPerMonth: (sessions) => `${sessions} conversion journeys/month`,
    replayRetention: (retention) => `${retention} of checkout, onboarding, and paywall evidence`,
