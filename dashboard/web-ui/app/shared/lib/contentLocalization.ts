...
const englishContentCopy: ContentLocaleCopy = {
  ...
  pricing: {
    ...
    planDescriptions: {
      free: "For validating the funnel before traffic ramps.",
      starter: "For finding the first leaks in real traffic.",
      growth: "For ranking conversion leaks as traffic scales.",
      pro: "For high-volume product, checkout, and onboarding flows.",
      scale: "For high-scale revenue leak work with Smart Capture control.",
    ...
    perMonth: "per month",
    perYear: "per year",
    sessionsPerMonth: (sessions) => `${sessions} captured sessions/month for leak detection`,
    replayRetention: (retention) => `${retention} of conversion evidence history`,
    ...
    comparisonSubtitle: "Rejourney fixed pricing vs usage-based replay pricing, with analytics included.",
    sessionsPerMonthLabel: "Captured sessions per month",
    monthlySessionsAriaLabel: "Monthly captured sessions",
